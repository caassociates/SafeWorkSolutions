    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div  class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background: url(images/Logistics-Shipping-Flexe-Amazon.jpg); background-repeat: no-repeat; background-size: cover;">
            <div class="carousel-container">
              <div class="carousel-content">
                <h1 class="animate__animated animate__fadeInDown" style="color:white; font-size: 45px;">CORPORATE FORKLIFT<br> TRAINING PROGRAMS </h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 element-animate ">
                <div class="media block-6 d-block text-center">
                    <!-- <div class="icon mb-3">
                        <span class="ion-bookmark text-primary">
                        </span>
                    </div> -->
                    <div class="animate__animated animate__fadeInUp">
                        ...
                        <p>
                            New Operator / Beginner Forklift Training Programs are designed for individuals who have minimal to no experience operating a lift truck or looking to learn a new class of lift equipment.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 element-animate ">
                <div class="media block-6 d-block text-center">
                   <!--  <div class="icon mb-3">
                        <span class="ion-heart text-primary">
                        </span>
                    </div> -->
                    <div class="animate__animated animate__fadeInUp">
                        <h3>
                        ...
                        <p>
                            ...
                            Programs are for individuals with minimal operating experience who require practice, those who have not been trained professionally.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 element-animate ">
                <div class="media block-6 d-block text-center">
                    <!-- <div class="icon mb-3">
                        <span class="ion-leaf text-primary">
                        </span>
                    </div> -->
                    <div class="animate__animated animate__fadeInUp">
                        <h3>
                        ...
                        <p>
                            Advanced or Renewal Forklift Training Programs are designed for experienced individuals and / or have been previously certified with an expired certificate.
                        </p>
                    </div>
                </div>
            </div>
